...
dash.register_page(__name__, name='Career Records')
...
layout = dbc.Container([
    ...
    dcc.Markdown('''
        ...
        Choose a statistic:
    ''', className='pt-2'),
    html.Div(dcc.Dropdown(id='dropdown0', options=dpdown0, value='Passing'),className="dbc w-50"),
    html.Div(dcc.Dropdown(id='dropdown', options=dpdown, value='Pass Yds'),className='dbc w-50'),
    html.Div(id='table-container',  className='tableDiv w-90'),
],className='dbc')
...
def display_table(value):
    ...
    df_temp = career.loc[career[limit[0]] >= limit[1],['FullName', value]].rename(columns={'FullName':'Player'})
